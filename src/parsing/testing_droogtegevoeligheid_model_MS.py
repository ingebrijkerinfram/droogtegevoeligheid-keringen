...
def plot(df, TAW, grondsoort, dijkvak_id, jaar=None, ens=None):
    ...
    path = r'C:\Users\marloes.slokker\Infram BV\Infram Projecten - 000370 Droogtegevoeligheid keringen RWS\Uitvoering\Methode\droogtegevoeligheid-keringen\folderstructuur\Ref\2005'
